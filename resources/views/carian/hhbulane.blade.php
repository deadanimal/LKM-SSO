...
<body>
    ...
    <div style="text-align: center; margin-bottom:15px;">
        Monthly average dealer purchase prices of cocoa beans quoted by the Malaysian Cocoa Board for the month
        {{ $bulane }} {{ $tahun_user }}
    </div>
    <table class="table table-bordered" style="width:80%; margin-left:auto;margin-right:auto; border:1px solid black; ">
        <thead style="font-family: Arial, Helvetica, Sans-Serif; font-size: 12pt; font-weight:bold;">
            <tr>
                <th scope="col" rowspan="3" style="padding:1.5px; text-align:center">Center </th>
        ...
        <tbody>
            @foreach ($result as $r)
                <tr>
                    ...
                    <td style="padding:1.5px; text-align:center">{{ $r->PUSAT_KOD }}</td>

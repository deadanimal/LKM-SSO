...
<body>
    ...
    <div style="text-align: center; margin-bottom:15px;">
        {{-- Harga Koko pada tarikh {{ $tarikh_user }} --}}
        Daily dealer purchase prices of cocoa beans quoted by the Malaysian Cocoa Board on {{ $tarikh }}
    </div>
    <table class="table table-bordered" style="width:80%; margin-left:auto;margin-right:auto; border:1px solid black; ">
        <thead>
            <tr>
                <th scope="col" rowspan="3" style=" text-align:center">Center </th>
                <th scope="col" colspan="3" rowspan="2" style=" text-align:center">Wet Beans (Sen/Kg) </th>
                <th scope="col" colspan="9" style=" text-align:center" style="padding:1.5px; text-align:center">
                    Dry Beans (RM/Tonne)</th>
            </tr>
            <tr>

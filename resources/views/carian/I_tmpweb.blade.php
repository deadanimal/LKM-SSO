...
<body>
    ...
    <div style="text-align: center; margin-bottom:15px;">
        Maklumat Harga Koko Harian di pasaran antarabangsa Bagi Tarikh {{ $tarikh }}
    </div>
    <table class="table table-bordered" style="width:90%; margin-left:auto;margin-right:auto; border:1px solid black; ">
        <thead style="font-family: Arial, Helvetica, Sans-Serif; font-size: 12pt; font-weight:bold;">
            <th scope="col" style="text-align:center">Pasaran Hadapan </th>
            <th scope="col" style="text-align:center">Tinggi </th>
            <th scope="col" style="text-align:center">Rendah </th>
            <th scope="col" style="text-align:center">Tutup </th>
            <th scope="col" style="text-align:center">Future </th>
            <th scope="col" style="text-align:center">Kadar Tukaran Wang</th>
            <th scope="col" style="text-align:center">Harga Sebelum </th>
        </thead>
        <tbody>
            @foreach ($result as $r)
                <tr>
